...
define(function (require,exports,moudle) {
    ...
    var focus=require("../dist/focus.min");
    focus.focusDisplay("#searchTxt","#search-hot");

    //首页，职业课程，就业课程，极客社区，极客+ hover之后显示的下拉菜单
    var DisplaySubNav=require("../dist/DisplaySubNav.min");
    ...
    //图片的左右切换
    var ImgSwitch=require("../dist/ImgSwitch.min");
    ...
    var ImgSwitchMore=require("../dist/ImgSwitchMore.min");
...
//#main-course:hover #course-arrow-left{
    ...
    var RotateShowSpan=require("../dist/rotateShowSpan.min");
    RotateShowSpan.rotateShowSpan();

    //返回顶部
    var BackToTop=require("../dist/BackToTop.min");
